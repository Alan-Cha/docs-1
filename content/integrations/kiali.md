...
Currently the iter8 extension for Kiali works only for [iter8 v0.2.1](https://www.iter8abc.tools), not the current version. To install this version of iter8, see [here]({{< ref "kubernetes" >}}).
